...
protocol CycleScrollViewDelagate: class {
    func CycleScrollViewImageSelectedIndex(index:Int)
}
...
class CycleScrollView: UIView {
    ...
    /// 代理
    weak open var delegate: CycleScrollViewDelagate?
    /// 文字标题数组
    ...
    /// 指示器的位置 defaule is CycleScrollViewPageContolAlimentCenter
    var pageControlAliment = CycleScrollViewPageContolAliment(rawValue: 1)
    /// 是否显示分页控件
    ...
    /// 初始化方法1 本地图片
    class  func cycleScrollView(frame : CGRect,imagesGroup : NSArray) -> CycleScrollView {
    ...
    /// 初始化方法2 网络图片
    class  func cycleScrollView(frame : CGRect,imageURLGroup : NSArray) -> CycleScrollView {
        let cycleScrollView = CycleScrollView.init(frame: frame)
...
extension CycleScrollView{
    ...
    fileprivate func initConfiguration() {
        pageControlAliment = CycleScrollViewPageContolAliment.CycleScrollViewPageContolAlimentCenter
    ...
    fileprivate func setupMainView() {
        ...
        mainView?.register(CYCollectionViewCell.self, forCellWithReuseIdentifier: collectionViewCellID)
    ...
    override func layoutSubviews() {
        ...
        if pageControlAliment == CycleScrollViewPageContolAliment.CycleScrollViewPageContolAlimentRight {
...
extension CycleScrollView:UICollectionViewDelegate,UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: collectionViewCellID, for: indexPath) as! CYCollectionViewCell
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if self.delegate != nil {
            self.delegate?.CycleScrollViewImageSelectedIndex(index: indexPath.item % imagesGroup.count)
        }
    }
